                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            <a href="#" class='sidebar-link'>
                                <i class="bi bi-stack"></i>
                                <span>DeliveryCrg</span>
                            </a>
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="{{route('deliveryCrg.index')}}">DeliveryCrg List</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="{{route('deliveryCrg.create')}}">DeliveryCrg Create</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="{{route('coupon.create')}}">Coupon Create</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item  has-sub">
